 ...
 */
final class Version20230208155102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, supplier_id INT DEFAULT NULL, driver_id INT DEFAULT NULL, building_id INT DEFAULT NULL, platform_id INT DEFAULT NULL, dock_id INT DEFAULT NULL, logistic_leader_id INT DEFAULT NULL, title VARCHAR(100) DEFAULT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL, all_day TINYINT(1) DEFAULT NULL, background_color VARCHAR(255) DEFAULT NULL, border_color VARCHAR(255) DEFAULT NULL, text_color VARCHAR(255) DEFAULT NULL, pallets_number INT DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, come DATETIME DEFAULT NULL, deparure DATETIME DEFAULT NULL, command_number VARCHAR(255) DEFAULT NULL, speed_save TINYINT(1) DEFAULT NULL, checked VARCHAR(255) DEFAULT NULL, checked_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', checked_by VARCHAR(255) DEFAULT NULL, validated VARCHAR(255) DEFAULT NULL, validated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', validated_by VARCHAR(255) DEFAULT NULL, INDEX IDX_6EA9A1469395C3F3 (customer_id), INDEX IDX_6EA9A1462ADD6D8C (supplier_id), INDEX IDX_6EA9A146C3423909 (driver_id), INDEX IDX_6EA9A1464D2A7E12 (building_id), INDEX IDX_6EA9A146FFE6496F (platform_id), INDEX IDX_6EA9A146B0826BBA (dock_id), INDEX IDX_6EA9A14694379C21 (logistic_leader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, mail VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE logistic_leader (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, mail VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE calendar ADD CONSTRAINT FK_6EA9A14694379C21 FOREIGN KEY (logistic_leader_id) REFERENCES logistic_leader (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calendar DROP FOREIGN KEY FK_6EA9A14694379C21');
        ...
        $this->addSql('DROP TABLE logistic_leader');
